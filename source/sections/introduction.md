...
There is data and network segmentation in place but differently implemented on Rackspace, AWS, Azure, and Softlayer versions of the Catalyze Platform.
