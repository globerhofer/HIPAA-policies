...
2. The Human Resources Department, users, and supervisors are required to notify the IS Help Desk to terminate a user's access rights if there is evidence or reason to believe the following (these incidents are also reported on an incident report and is filed with the Privacy Officer):
...
6. Passwords are inactivated immediately upon an employee's termination (refer to the [termination procedures in section 7.10 of this policy](#7.10-employee-termination-procedures).
